...
export default function InfoLSADeclaration({year}) {
  return <p>
      ...
      Awards recognition events. This personal information is required to process your application
      ...
      of this information can be directed to Program Manager, <a href="mailto:LongServiceAwards@gov.bc.ca">LongServiceAwards@gov.bc.ca</a>, 1st floor -
