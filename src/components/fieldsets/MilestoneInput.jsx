...
export default function MilestoneInput({ type, threshold }) {
  ...
  const { control, setValue, clearErrors, resetField, getValues } =
    useFormContext();
        ...
        <div className="grid">
          <div className={"col-12 form-field-container"}>
            <label htmlFor={"service_years"}>
              Enter your total BCPS years of service{" "}
              <InfoToolTip
          ...
          <div className={"col-12 form-field-container"}>
            <InfoServiceEligibility
              type={type}
              milestone={getValues(`service.milestone`)}
            />
          </div>
          <div className="col-12 form-field-container">
