...
import {getMilestones, getQualifyingYears, getOrganizations} from "@/services/api.routes.js";
...
export default function EmployeeInput({index, remove}) {
    ...
    // set local states
    const { control, resetField, getValues, setValue, clearErrors } = useFormContext();
    ...
    const selectedMilestone = useWatch({name: `employees.${index}.service.milestone`});
    ...
    const calculateMilestone = () => {
        ...
        resetField(`employees.${index}.service.prior_milestones`, { defaultValue: [] });
        resetField(`employees.${index}.service.qualifying_year`, { defaultValue: "" });
        ...
        setValue(`employees.${index}.service.milestone`,
    ...
    return <Fieldset className={'m-3'} legend={<>Employee {index + 1}</>}>
        <div className="container">
            <div className="grid">
                <div className={'col-12 form-field-container'}>
                    <label htmlFor={`employees.${index}.contact.first_name`}>First Name</label>
                    <Controller
                ...
                <div className="col-12 form-field-container">
                    <label htmlFor={`employees.${index}.contact.last_name`}>Last Name</label>
                    <Controller
                ...
                <div className="col-12 form-field-container">
                    <label htmlFor={`employees.${index}.contact.office_email`}>
                        Government Email Address (If retired, enter employee's preferred email address)
                    </label>
                    <Controller
                ...
                <div className="col-12 form-field-container">
                    <label htmlFor={`employees.${index}.employee_number`}>Employee Number (six digits)</label>
                    <Controller
                ...
                <div className="col-12 form-field-container">
                    <label htmlFor={`employees.${index}.organization.id`}>Ministry/Organization</label>
                    <Controller
                ...
                <div className={'col-12 form-field-container'}>
                    <label htmlFor={`employees.${index}.service.service_years`}>
                        Enter employee's total BCPS years of service <InfoToolTip
                    ...
                    <Controller
                        ...
                        control={control}
                        rules={{required: "Enter employee's number of BCPS service years."}}
                        render={({ field, fieldState: {invalid, error} }) => (
                            <>
