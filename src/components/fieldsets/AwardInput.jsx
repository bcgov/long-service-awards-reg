...
export default function AwardInput() {
  ...
  const currentAward =
    useWatch({ control, name: "service.awards.award" }) || {};
  ...
  const gridItem = (item) => {
    return (
      <div className="col-4 sm:col-6 md:col-4 lg:col-4 xl:col-4 p-2">
        <div className="p-4 border-1 surface-border surface-card border-round">
          <div className="flex flex-wrap align-items-center justify-content-between gap-2">
  ...
  return (
    <>
      ...
      <BlockUI
        blocked={!currentMilestone && !loading}
        template={
          <Button
            onClick={() => {
